...
namespace Editor
{
    public class AnysongPlayerControls : UnityEditor.Editor
    {
        private static Sprite _tapeSprite1;
        private static Sprite _tapeSprite2;
        private static bool _isPreviewing;
        private static Button _playButton;
        private static AnysongPlayer _anysongPlayer;
        private static AnysongObject _currentSong;
        public static Color AccentColor = new Color(0.3764705882f, 0.7803921569f, 0.3607843137f, 1);
        private static VisualElement _tapeElement;


        public static void HandlePlayerLogic(VisualElement root, AnysongPlayer anysongPlayer)
        {
        ...
        public static void SetSongObject(AnysongObject anysongObject)
        {
