...
namespace Anysong
{
    public static class AnysongPatternControls
    {
        ...
        public static VisualElement Draw()
        {
            ...
            bool isPercussion = AnysongEditorWindowNew.CurrentSelection.CurrentSongTrackSettings.instrument is AnywhenSampleInstrument sampleInstrument &&
            ...
            if (!isPercussion)
            {
                ...
                if (AnysongEditorWindowNew.CurrentSelection.CurrentSongTrackSettings.voices == 1)
                    OnMono();
                else
                    OnPoly();
            }
