...
namespace Anysong
{
    public static class AnywhenSnapshotHandler
    {
        ...
        private static List<PropertyValue> _snapshotA = new();
        private static List<PropertyValue> _snapshotB = new();
        private static float _blendT = 0f;

        // --- Capture ---
        public static void CaptureSnapshot(SerializedObject serializedObject, ref List<PropertyValue> snapshot)
        {
        ...
        private static PropertyValue? ReadProperty(SerializedProperty prop)
        {
        ...
        // --- Blend / Apply ---
        public static void ApplyBlend(SerializedObject serializedObject, float t)
        {
            // Build lookup for B
...
//        Undo.RecordObject(target, "Blend Snapshots");
        ...
        private static void WriteBlended(SerializedProperty prop, PropertyValue a, PropertyValue b, float t)
        {
            switch (a.type)
            {
