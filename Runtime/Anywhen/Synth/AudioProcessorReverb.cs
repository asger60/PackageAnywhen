...
namespace Anywhen.Synth
{
    public struct AudioProcessorReverb : IAudioProcessor, System.IDisposable
    {
        ...
        private NativeArray<int> _combDelaysL;
        private NativeArray<int> _combDelaysR;
        private NativeArray<int> _allpassDelays;
        ...
        public void Dispose()
        {
            ...
            if (_combDelaysL.IsCreated) _combDelaysL.Dispose();
            if (_combDelaysR.IsCreated) _combDelaysR.Dispose();
            if (_allpassDelays.IsCreated) _allpassDelays.Dispose();
